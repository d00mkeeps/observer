...
def handle_help_command() -> str:
    ...
    return (
        ...
        "• <code>/update [service]</code> — Pull latest code from GitHub main & rebuild container\n"
        "• <code>/errors [1h|24h|7d]</code> — Direct Loki error audit across all apps\n"
        ...
        "• <i>\"Inspect the Clearbox code for how pgvector embeddings are cached\"</i>\n\n"
        "<i>Note: All commands work with or without a slash (<code>/spec</code> or <code>spec</code>).</i>"
    )
